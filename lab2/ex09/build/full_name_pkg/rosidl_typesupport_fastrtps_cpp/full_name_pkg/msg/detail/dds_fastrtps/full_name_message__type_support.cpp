...
#include "full_name_pkg/msg/detail/full_name_message__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = full_name_pkg::msg::FullNameMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const full_name_pkg::msg::FullNameMessage *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<full_name_pkg::msg::FullNameMessage *>(
    untyped_ros_message);
...
{
  return &full_name_pkg::msg::typesupport_fastrtps_cpp::_FullNameMessage__handle;
}
