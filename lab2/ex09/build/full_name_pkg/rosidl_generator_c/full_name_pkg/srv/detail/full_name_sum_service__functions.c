...
full_name_pkg__srv__FullNameSumService_Request__init(full_name_pkg__srv__FullNameSumService_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->last_name)) {
    full_name_pkg__srv__FullNameSumService_Request__fini(msg);
    return false;
  }
  // name
...
full_name_pkg__srv__FullNameSumService_Request__create(void)
{
  ...
  full_name_pkg__srv__FullNameSumService_Request * msg = (full_name_pkg__srv__FullNameSumService_Request *)allocator.allocate(sizeof(full_name_pkg__srv__FullNameSumService_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(full_name_pkg__srv__FullNameSumService_Request));
  bool success = full_name_pkg__srv__FullNameSumService_Request__init(msg);
  if (!success) {
...
full_name_pkg__srv__FullNameSumService_Request__Sequence__init(full_name_pkg__srv__FullNameSumService_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  full_name_pkg__srv__FullNameSumService_Request * data = NULL;

  if (size) {
    data = (full_name_pkg__srv__FullNameSumService_Request *)allocator.zero_allocate(size, sizeof(full_name_pkg__srv__FullNameSumService_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = full_name_pkg__srv__FullNameSumService_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        full_name_pkg__srv__FullNameSumService_Request__fini(&data[i - 1]);
      }
...
full_name_pkg__srv__FullNameSumService_Request__Sequence__fini(full_name_pkg__srv__FullNameSumService_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      full_name_pkg__srv__FullNameSumService_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  full_name_pkg__srv__FullNameSumService_Request__Sequence * array = (full_name_pkg__srv__FullNameSumService_Request__Sequence *)allocator.allocate(sizeof(full_name_pkg__srv__FullNameSumService_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = full_name_pkg__srv__FullNameSumService_Request__Sequence__init(array, size);
  if (!success) {
...
full_name_pkg__srv__FullNameSumService_Request__Sequence__destroy(full_name_pkg__srv__FullNameSumService_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    full_name_pkg__srv__FullNameSumService_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
full_name_pkg__srv__FullNameSumService_Request__Sequence__are_equal(const full_name_pkg__srv__FullNameSumService_Request__Sequence * lhs, const full_name_pkg__srv__FullNameSumService_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!full_name_pkg__srv__FullNameSumService_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  full_name_pkg__srv__FullNameSumService_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(full_name_pkg__srv__FullNameSumService_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    full_name_pkg__srv__FullNameSumService_Request * data =
      (full_name_pkg__srv__FullNameSumService_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!full_name_pkg__srv__FullNameSumService_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          full_name_pkg__srv__FullNameSumService_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!full_name_pkg__srv__FullNameSumService_Request__copy(
...
full_name_pkg__srv__FullNameSumService_Response__init(full_name_pkg__srv__FullNameSumService_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->full_name)) {
    full_name_pkg__srv__FullNameSumService_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  full_name_pkg__srv__FullNameSumService_Response * msg = (full_name_pkg__srv__FullNameSumService_Response *)allocator.allocate(sizeof(full_name_pkg__srv__FullNameSumService_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(full_name_pkg__srv__FullNameSumService_Response));
  bool success = full_name_pkg__srv__FullNameSumService_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
full_name_pkg__srv__FullNameSumService_Response__Sequence__init(full_name_pkg__srv__FullNameSumService_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  full_name_pkg__srv__FullNameSumService_Response * data = NULL;

  if (size) {
    data = (full_name_pkg__srv__FullNameSumService_Response *)allocator.zero_allocate(size, sizeof(full_name_pkg__srv__FullNameSumService_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = full_name_pkg__srv__FullNameSumService_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        full_name_pkg__srv__FullNameSumService_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
full_name_pkg__srv__FullNameSumService_Response__Sequence__fini(full_name_pkg__srv__FullNameSumService_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      full_name_pkg__srv__FullNameSumService_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  full_name_pkg__srv__FullNameSumService_Response__Sequence * array = (full_name_pkg__srv__FullNameSumService_Response__Sequence *)allocator.allocate(sizeof(full_name_pkg__srv__FullNameSumService_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = full_name_pkg__srv__FullNameSumService_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
full_name_pkg__srv__FullNameSumService_Response__Sequence__destroy(full_name_pkg__srv__FullNameSumService_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    full_name_pkg__srv__FullNameSumService_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
full_name_pkg__srv__FullNameSumService_Response__Sequence__are_equal(const full_name_pkg__srv__FullNameSumService_Response__Sequence * lhs, const full_name_pkg__srv__FullNameSumService_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!full_name_pkg__srv__FullNameSumService_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  full_name_pkg__srv__FullNameSumService_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(full_name_pkg__srv__FullNameSumService_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    full_name_pkg__srv__FullNameSumService_Response * data =
      (full_name_pkg__srv__FullNameSumService_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!full_name_pkg__srv__FullNameSumService_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          full_name_pkg__srv__FullNameSumService_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!full_name_pkg__srv__FullNameSumService_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
full_name_pkg__srv__FullNameSumService_Event__init(full_name_pkg__srv__FullNameSumService_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    full_name_pkg__srv__FullNameSumService_Event__fini(msg);
    return false;
  }
  // request
  if (!full_name_pkg__srv__FullNameSumService_Request__Sequence__init(&msg->request, 0)) {
    full_name_pkg__srv__FullNameSumService_Event__fini(msg);
    return false;
  }
  // response
  if (!full_name_pkg__srv__FullNameSumService_Response__Sequence__init(&msg->response, 0)) {
    full_name_pkg__srv__FullNameSumService_Event__fini(msg);
    return false;
  }
  return true;
...
full_name_pkg__srv__FullNameSumService_Event__fini(full_name_pkg__srv__FullNameSumService_Event * msg)
{
  ...
  // request
  full_name_pkg__srv__FullNameSumService_Request__Sequence__fini(&msg->request);
  // response
  full_name_pkg__srv__FullNameSumService_Response__Sequence__fini(&msg->response);
}
...
full_name_pkg__srv__FullNameSumService_Event__are_equal(const full_name_pkg__srv__FullNameSumService_Event * lhs, const full_name_pkg__srv__FullNameSumService_Event * rhs)
{
  ...
  // request
  if (!full_name_pkg__srv__FullNameSumService_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!full_name_pkg__srv__FullNameSumService_Response__Sequence__are_equal(
  ...
  full_name_pkg__srv__FullNameSumService_Event * output)
{
  ...
  // request
  if (!full_name_pkg__srv__FullNameSumService_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!full_name_pkg__srv__FullNameSumService_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  full_name_pkg__srv__FullNameSumService_Event * msg = (full_name_pkg__srv__FullNameSumService_Event *)allocator.allocate(sizeof(full_name_pkg__srv__FullNameSumService_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(full_name_pkg__srv__FullNameSumService_Event));
  bool success = full_name_pkg__srv__FullNameSumService_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
full_name_pkg__srv__FullNameSumService_Event__Sequence__init(full_name_pkg__srv__FullNameSumService_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  full_name_pkg__srv__FullNameSumService_Event * data = NULL;

  if (size) {
    data = (full_name_pkg__srv__FullNameSumService_Event *)allocator.zero_allocate(size, sizeof(full_name_pkg__srv__FullNameSumService_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = full_name_pkg__srv__FullNameSumService_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        full_name_pkg__srv__FullNameSumService_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
full_name_pkg__srv__FullNameSumService_Event__Sequence__fini(full_name_pkg__srv__FullNameSumService_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      full_name_pkg__srv__FullNameSumService_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  full_name_pkg__srv__FullNameSumService_Event__Sequence * array = (full_name_pkg__srv__FullNameSumService_Event__Sequence *)allocator.allocate(sizeof(full_name_pkg__srv__FullNameSumService_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = full_name_pkg__srv__FullNameSumService_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
full_name_pkg__srv__FullNameSumService_Event__Sequence__destroy(full_name_pkg__srv__FullNameSumService_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    full_name_pkg__srv__FullNameSumService_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
full_name_pkg__srv__FullNameSumService_Event__Sequence__are_equal(const full_name_pkg__srv__FullNameSumService_Event__Sequence * lhs, const full_name_pkg__srv__FullNameSumService_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!full_name_pkg__srv__FullNameSumService_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  full_name_pkg__srv__FullNameSumService_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(full_name_pkg__srv__FullNameSumService_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    full_name_pkg__srv__FullNameSumService_Event * data =
      (full_name_pkg__srv__FullNameSumService_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!full_name_pkg__srv__FullNameSumService_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          full_name_pkg__srv__FullNameSumService_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!full_name_pkg__srv__FullNameSumService_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
