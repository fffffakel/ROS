...
class Metaclass_FullNameSumService_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('full_name_pkg')
        except ImportError:
            import logging
            import traceback
...
class FullNameSumService_Event(metaclass=Metaclass_FullNameSumService_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<full_name_pkg/FullNameSumService_Request, 1>',
        'response': 'sequence<full_name_pkg/FullNameSumService_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['full_name_pkg', 'srv'], 'FullNameSumService_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['full_name_pkg', 'srv'], 'FullNameSumService_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from full_name_pkg.srv import FullNameSumService_Request
    ...
    def response(self, value):
        if self._check_fields:
            from full_name_pkg.srv import FullNameSumService_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_FullNameSumService(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'full_name_pkg.srv.FullNameSumService')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from full_name_pkg.srv import _full_name_sum_service
...
class FullNameSumService(metaclass=Metaclass_FullNameSumService):
    from full_name_pkg.srv._full_name_sum_service import FullNameSumService_Request as Request
    from full_name_pkg.srv._full_name_sum_service import FullNameSumService_Response as Response
    from full_name_pkg.srv._full_name_sum_service import FullNameSumService_Event as Event
